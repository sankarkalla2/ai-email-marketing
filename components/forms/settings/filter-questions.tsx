      ...
      <CardContent className="p-6 border-r-[1px]">
        ...
        <form onSubmit={onSubmitQuestion} className="flex flex-col gap-6 mt-10">
          <div className="flex flex-col gap-3">
            <HeadingLabel
              label="question"
              message="Add a question that you want to ask bot"
            />
            <FormGenerator
              inputType="input"
              register={register}
            ...
            isQuestions.map((question) => (
              ...
              >
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>{question.answered}</AccordionContent>
                </AccordionItem>
              </Accordion>
            ))
          ) : (
